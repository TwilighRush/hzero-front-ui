...
const stepsData: ComponentData = {
  ...
  data: [
    {
      ...
      iconSize: 24,
      //完成
      finishfontColor: 'rgba(0,0,0,0.65)',
      // finishIconBorderColor: '#0840f8',
      finishIconBg: '#fff',
      finishBarBg: '#5365EA',
      // finishIconColor: '#0840f8',
      // 处理中
      processFontColor: 'rgba(0,0,0,0.85)',
      processIconBorder: 'none',
      // processIconBg: '#0840f8',
      processBarBg: '#5365EA',
      processIconColor: '#fff',
      //等待中
      waitingFontColor: 'rgba(0,0,0,0.45)',
      waitingBarBg: '#D9E6F2',
      waitingIconBorderColor: 'rgba(0,0,0,0.15)',
      waitingIconBg: '#fff',
      waitingIconColor: 'rgba(0,0,0,0.25)',
  ...
  onlyTemplate: [stepsStyle, stepsHzeroStyle],
};
