          ...
          .c7n-tabs-bar-inner > .c7n-tabs-nav-container {
            ...
            .c7n-tabs-nav-wrap {
              .c7n-tabs-nav-scroll {
                .c7n-tabs-nav {
                  .c7n-tabs-ink-bar {
                    background: ${d.lineBottomBorderColor || colors.primary};
                    bottom: ${d.bottom};
                  ...
                  .c7n-tabs-tab {
                    ...
                    .c7n-tabs-tab {
                      ...
                      &.c7n-tabs-tab-active {
                        ...
                        :nth-of-type(2) {
                          border-left: ${d.tabBorderWidth}px solid
                            ${d.tabBorderColor};
...
function getCardStyle(props) {
  ...
  return css`
    .c7n-tabs-nav-add.c7n-tabs-nav-add {
      position: inherit;
      height: ${d.height}px;
    }
...
export default createStyleComponent("comp/tabs", tabsCss);
