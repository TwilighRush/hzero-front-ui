  ...
  return css`
    ...
    .c7n-btn.c7n-btn {
      ...
      &.c7n-btn-flat:not(.c7n-btn-circle) {
        ...
        :enabled:focus,
        :enabled:active {
          box-shadow: ${defaultActiveBoxShadow || "none"};
        ...
        &.c7n-btn-primary {
          ...
          :enabled:active {
            ...
            primaryHoverBorderColor};
            box-shadow: ${primaryActiveBoxShadow || primaryHoverBoxShadow};
          }
          &:disabled,
          &:disabled:hover {
          ...
          > .icon {
            background: ${primaryIconBackground};
          }
        }
        &.c7n-btn-dashed {
          background-color: ${dashedBgColor};
          color: ${dashedColor};
          border-color: ${dashedBorderColor};
          :enabled:hover {
            color: ${dashedHoverColor};
            background-color: ${dashedHoverBgColor};
            border-color: ${dashedHoverBorderColor};
          ...
          :enabled:active {
            ...
            border-color: ${dashedActiveBorderColor || dashedHoverBorderColor};
            box-shadow: ${dashedActiveBoxShadow || dashedHoverBoxShadow};
          }
          &:disabled,
          &:disabled:hover {
...
export default createStyleComponent("comp/button", allCss);
