...
// rem转px之后，计算方式也要改变
const getAfterWidth = (w) => Math.floor(Math.sqrt((w * w * 10000) / 2)) / 100;
...
const stepsStyle = css`
  ...
  ${getStepsStyle}
  ${getStepsGroupStyle}
  ${getVerticalAndDotStyle}
`;

export default createStyleComponent("comp/steps", stepsStyle);
