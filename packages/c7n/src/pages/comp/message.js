...
const info = () => {
  ...
  const hide = message.info("abecada。", 100000);
  setTimeout(hide, 100000011000);
};

const success = () => {
  const hide = message.success("这是一条成功消息，会主动消失。", 100000);
  setTimeout(hide, 100000011000);
};
const load = () => {
  const hide = message.loading("load加载....", 100000);
      ...
      <Content>
        ...
        <div style={boxStyle}>
          <Row type="flex" justify="space-between">
            ...
            <Col span={6}>
              <Button onClick={load}>load加载中</Button>
            </Col>
          </Row>
        </div>
      </Content>
